...
import { NavbarLinksProps } from "../interfaces/INavbarLinksProps";
...
const NavbarLinks: React.FC<NavbarLinksProps> = ({ links, closeNavbar, isVertical = false }) => {
    ...
    return (
        <ul
            className={`flex ${isVertical ? "flex-col items-start" : "items-center"} gap-4 p-4 list-none`} // Sin marcadores
        >
